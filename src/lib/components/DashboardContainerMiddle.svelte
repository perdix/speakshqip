...
<div class="w-full mt-3  lg:mt-0 rounded-lg lg:ml-3 flex flex-col justify-start">
  ...
  <div class="grid grid-cols-2 gap-3 mt-5">
    <a href="/vocabulary" class="h-full">
      <button class="w-full h-full border-2 rounded-lg flex justify-center p-7 items-center flex-col transition-all hover:bg-zinc-200">
  ...
  <div class="mt-5 p-6 border-2 border-gray-300 bg-white rounded-lg">
    ...
    <p class="text-sm text-gray-700 mt-2">
      <span class="text-red-600 font-bold">{Math.floor(progress / 100 * totalLessons)}</span> out of <span class="text-red-600 font-bold">{totalLessons}</span> lessons completed.
    </p>
...
>>>>>>> 90bbe076fb246118722e175bb3cb800d122f0294
