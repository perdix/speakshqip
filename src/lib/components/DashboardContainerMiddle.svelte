<div class="w-full mt-3 rounded-lg md:mt-0 md:ml-3">
  <div class="grid grid-cols-2 gap-3 h-full">
    <a href="/vocabulary" class="h-full">
      <button
        class="w-full h-full border-2 rounded-lg flex justify-around p-7 items-center flex-col transition-all hover:bg-zinc-200"
      >
