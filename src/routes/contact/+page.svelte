				...
				<div>
					<label class="block text-sm font-medium text-gray-700 mb-2">
						...
						<input 
							...
							class="mt-1 block w-full border-b-2 border-gray-300 focus:border-red-500 transition-colors duration-300 outline-none pb-2"
						/>
					</label>
				</div>
				...
				<div>
					<label class="block text-sm font-medium text-gray-700 mb-2">
						...
						<textarea 
							...
							rows="4" 
							class="mt-1 block w-full border-b-2 border-gray-300 focus:border-red-500 transition-colors duration-300 outline-none resize-none pb-2"
						></textarea>
					</label>
				</div>
