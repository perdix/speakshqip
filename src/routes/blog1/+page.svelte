      ...
      <div class="bg-white rounded-2xl p-8 max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        ...
        <form on:submit|preventDefault={createBlog} class="space-y-6">
          ...
          <div class="flex justify-end space-x-4 pt-6">
            ...
            <button
              type="submit"
              class="px-6 py-3 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 transition-all duration-300 flex items-center shadow-md hover:shadow-lg"
              disabled={loading}
            >
              {#if loading}
