...
<div class="w-w-90/100 ml-auto mr-auto flex flex-col">
  ...
  <p class=" md:w-4/5 pointer-events-none p-4 bg-zinc-300 rounded-lg mt-4 font-bold text-zinc-500 flex justify-start items-center">
    Click on a word to hear its pronunciation <i class="fa-solid fa-arrow-pointer ml-3 text-xl"></i>
  </p>
  ...
  <div class="flex justify-between md:justify-start items-center flex-wrap w-full mt-4 mb-3">
