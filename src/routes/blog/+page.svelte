  ...
  <div class="bg-gradient-to-r from-gray-50 to-gray-100 border-b border-gray-200 py-8 px-8 shadow-sm">
    <div class="max-w-7xl mx-auto flex justify-between items-center">
      ...
      <button
        ...
        class="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-gray-900 rounded-lg hover:bg-gray-800 
        focus:ring-4 focus:ring-gray-300 transition-all duration-300 shadow-md hover:shadow-lg"
      >
        ...
        <form on:submit|preventDefault={createBlog} class="space-y-6">
          <div class="grid grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
              ...
              <input
                ...
                class="w-full rounded-lg border-gray-200 shadow-sm focus:border-blue-500
          ...
          <div class="space-y-2">
            ...
            <textarea
              ...
              class="w-full rounded-lg border-gray-200 shadow-sm focus:border-blue-500 focus:ring-2 
          ...
          <div class="flex justify-end space-x-4 pt-6">
            ...
            <button
            type="submit"
            class="px-6 py-3 bg-cd-red text-white rounded-lg text-sm font-medium
             hover:bg-cd-red-700 focus:ring-4 focus:ring-red-200 transition-all duration-300 flex items-center shadow-md hover:shadow-lg"
            disabled={loading}
          >
            {#if loading}
      ...
      <div class="mt-12 flex justify-center">
        <nav aria-label="Pagination" class="inline-flex rounded-md shadow-sm -space-x-px">
          ...
          <button
            ...
            class="relative inline-flex items-center px-4 py-2 border border-gray-300 bg-white 
